...
public class FileUtils {
    ...
    public static void saveFileDataToFileSystem (byte[] fileData, String filename, String fileTypeExtension) {
    ...
    public static String getBasenameFromPath (String path) {
        ...
        // ie - /Folder01/Folder02/myTxtFile.txt    will result as 'myTxtFile'      <- the extension is not included.
        String name = null;
        try {
    ...
    public static String getFilenameFromFilePath (String filePath) {
        return getBasenameFromPath(filePath) + "." + getFileExtensionFromFilePath(filePath);
    }
