...
java -cp $DIR/bin/h2*.jar org.h2.tools.Console -driver $H2_DRIVER -url $H2_URL -user $H2_USER -password $H2_PASS 2>/dev/null &
...
java -cp bin/h2*.jar org.h2.tools.Console -driver org.h2.Driver \
